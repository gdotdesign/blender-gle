...
Lattice.getCSS = function(selector, property) {
  if (Lattice.selectors[selector] != null) {
    return Lattice.selectors[selector][property] || null;
  }
};
Lattice.selectors = (function() {
  var selectors;
  selectors = {};
...
Iterable.ListItem = new Class({
  ...
  create: function() {
    this.title = new Element('div').addClass(this.get('class') + '-title');
